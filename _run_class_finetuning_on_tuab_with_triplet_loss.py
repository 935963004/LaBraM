...
from _engine_for_finetuning import train_one_epoch_triplet, evaluate
from _triplet_dataset import TUABTripletDataset
from utils import NativeScalerWithGradNormCount as NativeScaler
import utils

# python _run_class_finetuning_on_tuab_with_triplet_loss.py --normal_path home/dmedvedeva/TUAB/edf/train/normal/01_tcp_ar --abnormal_path home/dmedvedeva/TUAB/edf/train/abnormal/01_tcp_ar --triplet_loss_weight 0.1 ...(другие параметры, если нужно)
...
def get_dataset(args):
    if args.dataset == 'TUAB':
        ...
        if args.normal_path and args.abnormal_path:
            # NOT SURE IF ITS OK:
            train_dataset = TUABTripletDataset(args.normal_path, args.abnormal_path)
            test_dataset, val_dataset = None, None
        else:
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch_triplet(
