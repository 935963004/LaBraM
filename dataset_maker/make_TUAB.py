    ...
    for file in os.listdir(fetch_folder):
        if sub in file:
            ...
            for i in range(channeled_data.shape[1] // 2000):
                subfolder = "abnormal" if label == 1 else "normal"
                dump_path = os.path.join(dump_folder, subfolder, file.split(".")[0] + "_" + str(i) + ".pkl")
                pickle.dump(
...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.join(root, "processed_triplet")):
        os.makedirs(os.path.join(root, "processed_triplet"))

    if not os.path.exists(os.path.join(root, "processed_triplet", "train", "normal")):
        os.makedirs(os.path.join(root, "processed_triplet", "train", "normal"))
    if not os.path.exists(os.path.join(root, "processed_triplet", "train", "abnormal")):
        os.makedirs(os.path.join(root, "processed_triplet", "train", "abnormal"))
    train_dump_folder = os.path.join(root, "processed_triplet", "train")

    if not os.path.exists(os.path.join(root, "processed_triplet", "val", "normal")):
        os.makedirs(os.path.join(root, "processed_triplet", "val", "normal"))
    if not os.path.exists(os.path.join(root, "processed_triplet", "val", "abnormal")):
        os.makedirs(os.path.join(root, "processed_triplet", "val", "abnormal"))
    val_dump_folder = os.path.join(root, "processed_triplet", "val")

    if not os.path.exists(os.path.join(root, "processed_triplet", "test", "normal")):
        os.makedirs(os.path.join(root, "processed_triplet", "test", "normal"))
    if not os.path.exists(os.path.join(root, "processed_triplet", "test", "abnormal")):
        os.makedirs(os.path.join(root, "processed_triplet", "test", "abnormal"))
    test_dump_folder = os.path.join(root, "processed_triplet", "test")
