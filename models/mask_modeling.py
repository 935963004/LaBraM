...
class NeuralTransformerForMaskedEEGModeling(nn.Module):
    ...
    def forward(self, x: Tensor, input_chans=None, bool_masked_pos=None, return_all_tokens=False, return_patch_tokens=False,
...
class NeuralTransformerForMEM(nn.Module):
    ...
    def forward(self, x: Tensor, input_chans=None, bool_masked_pos=None):
